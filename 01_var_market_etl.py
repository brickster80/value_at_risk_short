...
portfolio_table = 'ft_ml_hub.im.ws_portfolio'
stock_table = 'ft_ml_hub.im.ws_stock'
stock_return_table = 'ft_ml_hub.im.ws_stock_return'
market_table = 'ft_ml_hub.im.ws_market'
market_return_table = 'ft_ml_hub.im.ws_market_return'
...
# MAGIC %sql
# MAGIC DESCRIBE HISTORY ft_ml_hub.im.ws_market_return

# COMMAND ----------

# DBTITLE 1,Access data at a specific version
# %sql
# SELECT * FROM ft_ml_hub.im.ws_market_return
# TIMESTAMP AS OF '2020-07-01'
